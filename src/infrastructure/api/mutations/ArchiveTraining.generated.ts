...
export type ArchiveTrainingMutationVariables = Types.Exact<{
  trainingId: Types.Scalars['Int'];
}>;

export type ArchiveTrainingMutation = {
  __typename?: 'Mutation';
  archiveTraining: { __typename?: 'Training'; id: number; title: string };
};

export const ArchiveTrainingDocument = `
    mutation archiveTraining($trainingId: Int!) {
  archiveTraining(trainingId: $trainingId) {
    id
    title
  }
}
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    archiveTraining: build.mutation<
      ArchiveTrainingMutation,
      ArchiveTrainingMutationVariables
    >({
      query: variables => ({ document: ArchiveTrainingDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useArchiveTrainingMutation } = injectedRtkApi;
