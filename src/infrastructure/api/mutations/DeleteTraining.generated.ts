...
export const DeleteTrainingDocument = `
    mutation deleteTraining($trainingId: Int!) {
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    ...
    >({
      query: variables => ({ document: DeleteTrainingDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useDeleteTrainingMutation } = injectedRtkApi;
