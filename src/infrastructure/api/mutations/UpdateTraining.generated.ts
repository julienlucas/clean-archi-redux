...
export type UpdateTrainingMutationVariables = Types.Exact<{
  trainingId: Types.Scalars['Int'];
  title?: Types.InputMaybe<Types.Scalars['String']>;
  description?: Types.InputMaybe<Types.Scalars['String']>;
  adaptiveLearning?: Types.InputMaybe<Types.Scalars['Boolean']>;
  language?: Types.InputMaybe<Types.Language>;
  modalities?: Types.InputMaybe<Array<Types.Modality> | Types.Modality>;
  screenSizes?: Types.InputMaybe<Array<Types.ScreenSize> | Types.ScreenSize>;
  disabilities?: Types.InputMaybe<Array<Types.Disability> | Types.Disability>;
  themeId?: Types.InputMaybe<Types.Scalars['String']>;
  colorScheme?: Types.InputMaybe<Types.Scalars['Int']>;
  prerequisite?: Types.InputMaybe<
    Array<Types.Scalars['String']> | Types.Scalars['String']
  >;
  objectives?: Types.InputMaybe<
    Array<Types.Scalars['String']> | Types.Scalars['String']
  >;
  skills?: Types.InputMaybe<
    Array<Types.Scalars['String']> | Types.Scalars['String']
  >;
  qualifications?: Types.InputMaybe<
    Array<Types.Scalars['String']> | Types.Scalars['String']
  >;
  targets?: Types.InputMaybe<
    Array<Types.Scalars['String']> | Types.Scalars['String']
  >;
}>;
...
export type UpdateTrainingMutation = {
  ...
  updateTraining: {
    ...
    createdAt: string;
    description: string;
    disabilities: Array<Types.Disability>;
    isValid: boolean;
    language: Types.Language;
    modalities: Array<Types.Modality>;
    screenSizes: Array<Types.ScreenSize>;
    title: string;
    author: {
      __typename?: 'LoadableAndragogueProfile';
      id: number;
    ...
    qualifications: Array<{ __typename?: 'Qualification'; title: string }>;
    skills: Array<{ __typename?: 'Skill'; name: string }>;
    targets: Array<{ __typename?: 'Target'; title: string }>;
    thumbnail?: {
      __typename?: 'Thumbnail';
      miniatureXPosition?: number;
      miniatureYPosition?: number;
      miniatureZoom?: number;
      path: string;
      xPosition?: number;
      yPosition?: number;
      zoom?: number;
...
export const UpdateTrainingDocument = `
    mutation updateTraining($trainingId: Int!, $title: String, $description: String, $adaptiveLearning: Boolean, $language: Language, $modalities: [Modality!], $screenSizes: [ScreenSize!], $disabilities: [Disability!], $themeId: String, $colorScheme: Int, $prerequisite: [String!], $objectives: [String!], $skills: [String!], $qualifications: [String!], $targets: [String!]) {
  updateTraining(
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    ...
    >({
      query: variables => ({ document: UpdateTrainingDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useUpdateTrainingMutation } = injectedRtkApi;
