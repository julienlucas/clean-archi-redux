...
export type AllTrainingsQueryVariables = Types.Exact<{ [key: string]: never }>;

export type AllTrainingsQuery = {
  __typename?: 'Query';
  allTrainings: Array<{
    __typename?: 'Training';
    id: number;
    ...
    author: {
      __typename?: 'LoadableAndragogueProfile';
      id: number;
      profile: { __typename?: 'LoadableUserAccount'; id: number };
    };
    thumbnail?: { __typename?: 'Thumbnail'; path: string };
    modules: Array<
      | {
          __typename?: 'LoadableActivityModule';
          id: number;
...
export const AllTrainingsDocument = `
    query allTrainings {
  allTrainings {
    id
    state
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    allTrainings: build.query<
      AllTrainingsQuery,
      AllTrainingsQueryVariables | void
    >({
      query: variables => ({ document: AllTrainingsDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useAllTrainingsQuery, useLazyAllTrainingsQuery } =
  injectedRtkApi;
