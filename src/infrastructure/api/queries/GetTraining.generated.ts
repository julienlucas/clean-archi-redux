...
export type GetTrainingQueryVariables = Types.Exact<{
...
export type GetTrainingQuery = {
  ...
  getTraining?: {
    ...
    theme?: {
      __typename?: 'Theme';
      activityTypes: Array<Types.ActivityType>;
      author: string;
      bundle: string;
      colorSchemes: string;
      dateOfCreation: string;
      devices: Array<Types.ScreenSize>;
      disabilities: Array<Types.Disability>;
      fonts: Array<string>;
      id: string;
      is3d: boolean;
...
export const GetTrainingDocument = `
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    getTraining: build.query<GetTrainingQuery, GetTrainingQueryVariables>({
      query: variables => ({ document: GetTrainingDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useGetTrainingQuery, useLazyGetTrainingQuery } = injectedRtkApi;
