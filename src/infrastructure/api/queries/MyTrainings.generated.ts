...
export type MyTrainingsQueryVariables = Types.Exact<{ [key: string]: never }>;
          ...
          sessions: Array<{
            ...
            slots: Array<{
              ...
              invites: Array<{
                __typename?: 'LoadableSlotInvite';
                id: number;
                status: Types.SlotCoachInviteStatus;
                coach: {
                  __typename?: 'LoadableAndragogueProfile';
                  id: number;
                  profile: {
...
const injectedRtkApi = api.injectEndpoints({
  endpoints: build => ({
    myTrainings: build.query<
      MyTrainingsQuery,
      MyTrainingsQueryVariables | void
    >({
      query: variables => ({ document: MyTrainingsDocument, variables }),
    }),
  }),
});

export { injectedRtkApi as api };
export const { useMyTrainingsQuery, useLazyMyTrainingsQuery } = injectedRtkApi;
